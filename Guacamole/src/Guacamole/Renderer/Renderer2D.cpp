...
namespace Guacamole {
	...
	void Renderer2D::Init()
	{
		...
		// Vertex Array
		GM_CORE_ASSERT(!s_Data, "Renderer2D exceeding design.");
    ...
    void Renderer2D::DrawRotatedQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const glm::vec4& color)
    {
		...
		glm::mat4 transform = glm::translate(glm::mat4(1.0f), position) * glm::rotate(glm::mat4(1.0f), rotation, glm::vec3(0, 0, 1)) * glm::scale(glm::mat4(1.0f), { size.x, size.y, 1.0f });
