...
namespace Guacamole
{
    ...
    static void SerializeEntity(YAML::Emitter& out, Entity entity)
    {
        ...
        out << YAML::Key << "Entity" << YAML::Value << "1234567890"; // TODO: entityid goes here
    ...
    bool SceneSerializer::Deserialize(const std::string& filepath) 
    {
        ...
        GM_CORE_TRACE("Deserializing scene '{0}'", sceneName);
        ...
        if(entities)
        {
            for(auto entity : entities)
            {
                ...
                GM_CORE_TRACE("Deserialized entity with ID = {0}, name = {1}", uuid, name);
